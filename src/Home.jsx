        ...
        <>
            <div className="home bg-purple-50 h-full">
                <div className="container absolute flex flex-col items-center">
                    ...
                    <div className="text-5xl font-bold text-purple-500 animation3">Myntor</div>
                </div>
                <img className="bgimg w-52 absolute" src={bgimg} alt="" />
                <Link to={"/quiz"}><button className="btn-begin absolute mt-10 p-2 m-4 border-2 border-red-100 bg-cyan-500 rounded-md">Let's Begin the Show</button></Link>
            </div>
        </>
    )
}
